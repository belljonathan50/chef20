...
var json5 = require('./json5.json');
var json6 = require('./json6.json');
var json7 = require('./json7.json');
var json8 = require('./json8.json');
...
//  function definition 
function EncodeMeasure(foo, bar, noo, gar, voo, woo, xoo, yoo) {
  ...
  //   });
      // 2/ start loop from 0
   for (let i = 1 ; i < voo.length/2; i++)        {
    fs.appendFileSync('/Users/jonathanbell/Documents/GitHub/chef20/antescofo/score-to-antescofo.asco.txt', 
    voo[i*2-1] +" sop2 "+ voo[i*2]+ "\n" 
    , function (err) {if (err) throw err });   }
                     }
  // else if no silence start loop from 1 and make the beginning manually
    else {
  ...
  //   });
      // 2/ start loop from 0
   for (let i = 1 ; i < woo.length/2; i++)        {
    fs.appendFileSync('/Users/jonathanbell/Documents/GitHub/chef20/antescofo/score-to-antescofo.asco.txt', 
    woo[i*2-1] +" sop2 "+ woo[i*2]+ "\n" 
    , function (err) {if (err) throw err });   }
                     }
  // else if no silence start loop from 1 and make the beginning manually
    else {
  ...
  //   });
      // 2/ start loop from 0
   for (let i = 1 ; i < xoo.length/2; i++)        {
    fs.appendFileSync('/Users/jonathanbell/Documents/GitHub/chef20/antescofo/score-to-antescofo.asco.txt', 
    xoo[i*2-1] +" sop2 "+ xoo[i*2]+ "\n" 
    , function (err) {if (err) throw err });   }
                     }
  // else if no silence start loop from 1 and make the beginning manually
    else {
  ...
  //   });
      // 2/ start loop from 0
   for (let i = 1 ; i < yoo.length/2; i++)        {
    fs.appendFileSync('/Users/jonathanbell/Documents/GitHub/chef20/antescofo/score-to-antescofo.asco.txt', 
    yoo[i*2-1] +" sop2 "+ yoo[i*2]+ "\n" 
    , function (err) {if (err) throw err });   }
                     }
  // else if no silence start loop from 1 and make the beginning manually
    else {
...
// use it
    EncodeMeasure(foo, bar, noo, gar, voo, woo, xoo, yoo)  
  }
